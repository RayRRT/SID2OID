...
namespace Crypt
{
    ...
    public static class CertSidExtension
    {
        ...
        public static byte[] EncodeSidExtension(SecurityIdentifier sid)
        {
            ...
            var sidOid = "1.3.6.1.4.1.311.25.2";
...
# Define the SID you want to encode
$Sid = "S-1-5-21-1468012755-800561317-457473099-500"

# Encode the SID as an extension (returns a byte array)
...
# Output the ASN.1 encoded value
Write-Output "ASN.1 Encoded SID:"
Write-Output $ValueHex

# Indicate the OID can now be used as a certificate extension
Write-Output "`nThe OID 1.3.6.1.4.1.311.25.2.1 can now be added as an extension to certificates with a strong mapping."
